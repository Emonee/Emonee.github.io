  ...
  return (
    <div className={styles.jumbotron}>
      ...
      <a className={`btn btn-white d-flex align-items-center gap-2 ${styles.button} ${styles.trans}`} href="#About">
        know me 
        <svg xmlns="http://www.w3.org/2000/svg" width="23" height="23" fill="currentColor" className={`bi bi-arrow-right-circle ${styles.rotate} ${styles.trans}`} viewBox="0 0 16 16">
